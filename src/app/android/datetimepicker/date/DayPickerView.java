 ...
 */
public class DayPickerView extends ListView implements OnScrollListener, DatePickerDialog.OnDateChangedListener {
...
void setUpListView() {
     ...
     */
    private
    SimpleMonthAdapter.CalendarDay findAccessibilityFocus() {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (child instanceof SimpleMonthView) {
                ...
                SimpleMonthAdapter.CalendarDay
		                focus = ((SimpleMonthView) child).getAccessibilityFocus();
                if (focus != null) {
